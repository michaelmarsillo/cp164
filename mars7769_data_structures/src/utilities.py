...
def list_test(source):
    ...
    for data in source:
        if not first.is_empty():
            ...
            print("max:", first.max())
            print("min:", first.min())
            print("count 99's:", first.count(99))
            print("index of 99", first.index(99))
            print("find 99:", first.find(99))
            print("removing 99:", first.remove(99))
        else:
            print("list is empty")
        line = data.strip().split("|")
        first.insert(0, int(line[3]))
        first.append(99)
